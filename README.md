...
The front-end team consisted of Hilmi and Arda, and the technology utilized includes: React Native, Redux, Bulma, Expo, and Azure Cloudinary. 
The back-end team consisted of Ipul and Ulfa, and the technology utilized includes: NodeJs, Mongodb Atlas, Mongoose, ExpressJs, Jest, and AWS.
